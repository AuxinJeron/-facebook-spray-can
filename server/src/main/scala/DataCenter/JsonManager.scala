...
case class GroupListJson(groupList: Set[String])
case class AddFileJson(userId: String, fileUrl: String, encrypt: Boolean, encryptedAES: String)
case class ShareFileJson(fileId: String, ownerId: String, inviteeIdList: Map[String, String])
case class ShareGroupFileJson(fileId: String, ownerId: String, groupId: String, AESKey: String)
...
object FacebookJsonProtocol extends DefaultJsonProtocol with NullOptions {
  ...
  implicit val GroupListJsonFormat = jsonFormat1(GroupListJson)
  implicit val AddFileJsonFormat = jsonFormat4(AddFileJson)
  implicit val FileJsonFormat = jsonFormat5(FileJson)
  implicit val ShareFileJsonFormat = jsonFormat3(ShareFileJson)
  implicit val ShareGroupFileJsonFormat = jsonFormat4(ShareGroupFileJson)
